        ...
        <div className='Serve py-10 md:py-20 px-4'>
            <div className='container text-center'>
                ...
                <p className='body-text text-center mt-10 md:mt-20'>Wherever you need to go, we ensure a safe, stylish, and hassle-free journey.<br /><br />
                    ...
                    At <b>  At Elite B Car, we offer exceptional private travel solutions focusing on comfort, elegance, and efficiency. Whether you're traveling for business, leisure, or a special event, we promise a premium, hassle-free, and luxurious ride from start to finish.<br /><br />
