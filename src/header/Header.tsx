            ...
            <header>
                <nav className="container flex items-center justify-between p-2" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <Link href="/" className="-m-1.5 p-1.5">
                            ...
                            <img loading="lazy" className="h-[80px] w-auto max-w-[200px]" src="/images/Logo_main1.svg" alt="Logo" />
                        </Link>
                    </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <Link href="/" className="-m-1.5 p-1.5">
                            <span className="sr-only">Your Company</span>
                            <img loading="lazy" className="h-[60px] w-auto max-w-[250px]" src="/images/Logo_main1.svg" alt="Logo" />
                        </Link>
