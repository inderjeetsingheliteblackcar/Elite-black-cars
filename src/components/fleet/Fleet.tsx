...
const fleetData = [
  ...
  },
  {
    ...
    image: "/images/Ourfleet2-min.jpg",
    passengers: 3,
    luggage: 4,
  },
  {
    ...
    image: "/images/Ourfleet3-min1.jpg",
    passengers: 2,
    luggage: 2,
  },
  // {
...
const Fleet = () => {
  ...
  return (
    <div className="" >
      ...
      <div ref={sectionRef} className=" md:block hidden fleet-main pt-20 pb-20">
        <div className=" relative">
          <div className="fleet sticky top-40  px-4 ">
